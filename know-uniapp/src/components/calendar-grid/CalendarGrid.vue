  ...
  <view class="cal-card">
    <view class="cal-nav">
      ...
      <view class="nav-right">
        ...
        <text class="collapse-btn" @tap="$emit('toggleCollapse')">{{ collapsed ? '展开' : '收起' }}</text>
      </view>
    </view>
    ...
    <view v-if="collapsed" class="cal-week-row">
      ...
      >
        ...
        <text v-if="day.primarySubLabel" class="wd-sub primary">{{ day.primarySubLabel }}</text>
        <text v-if="day.secondarySubLabel" class="wd-sub secondary">{{ day.secondarySubLabel }}</text>
    ...
    <view class="cal-summary">
      <text class="cs-main">{{ summaryInfo.prefix }} {{ summaryInfo.weekday }} · {{ summaryInfo.month }}/{{ summaryInfo.day }}</text>
        ...
        <view v-for="(week, wi) in weeks" :key="wi" class="cal-week">
          ...
          >
            <view class="day-top">
              ...
              <text v-if="day.events && day.events.length" class="day-cnt">{{ day.events.length }}</text>
            </view>
            <text
              v-if="day.festivalTag"
            ...
            <text
              ...
              class="day-primary"
              :class="{ holiday: day.isHoliday, term: day.isTerm && !day.holidayName && !day.festivalName }"
            >{{ day.primarySubLabel }}</text>
            <text v-if="day.secondarySubLabel" class="day-secondary">{{ day.secondarySubLabel }}</text>
