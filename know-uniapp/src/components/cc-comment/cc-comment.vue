    ...
    <view class="c_popup_box">
      <view class="reply_text">
        <template v-if="Object.keys(replyTemp).length">
          ...
          <img class="user_avatar" :src="replyTemp.item2 ? replyTemp.item2.userAvatar : replyTemp.item1.userAvatar" />
          <span class="text_main">{{ replyTemp.item2 ? replyTemp.item2.userNe : replyTemp.item1.userName }}</span>
        </template>
