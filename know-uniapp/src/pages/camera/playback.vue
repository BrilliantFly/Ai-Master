      ...
      <view class="timeline-section">
        ...
        <scroll-view class="timeline-scroll" scroll-x>
          <view class="timeline-track">
            ...
            >
              <view class="hour-label">{{ String(hour - 1).padStart(2, '0') }}:00</view>
              <view class="hour-bar">
                <!-- 录像片段 -->
                <view 
        ...
        <scroll-view class="record-list" scroll-y>
          ...
          >
            ...
            <view class="record-info">
              <text class="record-type">{{ getRecordTypeName(record.recordType) }}</text>
            ...
            <view class="record-actions">
              ...
              <text class="action-btn delete" @tap.stop="deleteRecord(record)">🗑</text>
            </view>
          </view>
