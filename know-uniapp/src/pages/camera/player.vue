...
import { getCameraDetail, startRecord, stopRecord as stopRecordApi, saveSnapshot, type CameraDevice } from '@/api/camera';
...
function showMenu() {
  uni.showActionSheet({
    ...
    success: (res) => {
      switch (res.tapIndex) {
        case 0: onQualityChange(currentQuality.value === 'main' ? 'sub' : 'main'); break;
        case 1: showDeviceInfo(); break;
        case 2: shareStream(); break;
